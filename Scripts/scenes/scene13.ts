module scenes {
    export class Scene13 extends objects.Scene {
        ...
        public start() : void {
            ...
            this._gameLabel = new objects.Label("SCENE 13", "60px Consolar", "#000000", config.Screen.CENTER_X, config.Screen.CENTER_Y);
