module scenes {
    export class Scene10 extends objects.Scene {
        ...
        public start() : void {
            ...
            this._gameLabel = new objects.Label("SCENE 10", "60px Consolar", "#000000", config.Screen.CENTER_X, config.Screen.CENTER_Y);
