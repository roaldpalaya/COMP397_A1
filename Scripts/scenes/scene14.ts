module scenes {
    export class Scene14 extends objects.Scene {
        ...
        public start() : void {
            ...
            this._gameLabel = new objects.Label("SCENE 14", "60px Consolar", "#000000", config.Screen.CENTER_X, config.Screen.CENTER_Y);
